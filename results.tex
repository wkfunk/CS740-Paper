...
This allowed us to easily fit our modifications in to only one section of the code with minimal debugging pain.
...
The ease of understanding the perceptual blocker code was aided by the fact that it is more of a proof of concept than a production-ready piece of software.
This means there are far fewer optimizations and 
